    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Game Ping Pong</h2>
          <ol>
            <li><a href="index.html">Home</a></li>
            <li>Game Ping Pong</li>
          </ol>
        </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/pgpg.PNG" alt="ini gambar gam ping pong">
                </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="portfolio-description">
              <h2>Game ping Pong</h2>
              <p>
                Game ping pong ini dibuat dengan menggunakan bahasa pemograman python. Seperti pada umumnya game ping pong, game ini memiliki tujuan untuk memasukan bola sebanyak banyaknya melewati kotak pemukul lawan.
              </p>
            </div>
          </div>
